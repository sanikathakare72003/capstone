from major.entity.artifact_entity import DataIngestionArtifact,DataValidationArtifact
from major.entity.config_entity import DataValidationConfig
from major.exception.exception import MajorException 
from major.logging.logger import logging 
from major.constant.training_pipeline import SCHEMA_FILE_PATH
from scipy.stats import ks_2samp
import pandas as pd
import os,sys
from major.utils.main_utils.utils import read_yaml_file,write_yaml_file
    ...
    def initiate_data_validation(self)->DataValidationArtifact:
        try:
            ...
            data_validation_artifact = DataValidationArtifact(
                ...
                valid_testing_file_path=self.data_ingestion_artifact.testing_file_path,
